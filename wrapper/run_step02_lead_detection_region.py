# ============================================================
# File: wrapper/run_step02.py
# ============================================================
#!/usr/bin/env python3
"""
============================================================
STEP 02 – OFFICIAL WRAPPER SCRIPT
============================================================

This wrapper script is the ONLY official entry point for Step 02
of the research pipeline.

HOW TO RUN:
    python wrapper/run_step02_lead_detection_region.py --input <input_dir> --output <output_dir>
EX:
    python wrapper/run_step02_lead_detection_region.py --input outputs/step01_grid_detection_and_dpi  --output results/step02_region
ARGUMENTS:
...
# ============================================================
from core_binary.step02_lead_detection_region_yolo import core_run
...
def main():
    parser = argparse.ArgumentParser(
        description="Run Step 02: Lead detection and auto-cropping (YOLO)"
    )
    ...
    print("=" * 60)
    print("🚀 STEP 02 – LEAD REGION DETECTION (YOLO)")
    print("=" * 60)
